import { remoteAssets } from './remoteAssets';
...
export const gameCatalog: GameDefinition[] = [
  {
    ...
    maxPlayers: 9,
    recommendedOrientation: 'landscape',
    cover: remoteAssets.covers.texasholdem,
    board: remoteAssets.boards.texasholdem,
  ...
  },
  {
    ...
    maxPlayers: 3,
    recommendedOrientation: 'landscape',
    cover: remoteAssets.covers.doudizhu,
    board: remoteAssets.boards.doudizhu,
  ...
  },
  {
    ...
    maxPlayers: 2,
    recommendedOrientation: 'landscape',
    cover: remoteAssets.covers.xiangqi,
    board: remoteAssets.boards.xiangqi,
  ...
  },
  {
    ...
    maxPlayers: 2,
    recommendedOrientation: 'landscape',
    cover: remoteAssets.covers.go,
    board: remoteAssets.boards.go,
