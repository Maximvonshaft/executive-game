...
import { remoteAssets } from '../constants/remoteAssets';

const avatarOptions = [
  { value: remoteAssets.ornaments.loginRing, label: '星环特效' },
  { value: remoteAssets.ornaments.swirl, label: '光晕旋涡' },
  { value: remoteAssets.covers.ai, label: '霓虹将军' },
  { value: remoteAssets.covers.chess, label: '棋士残影' }
];
